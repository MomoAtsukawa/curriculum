...
public class Task1_4 {
    ...
    public static void main(String[] args) {
        ...
        if (USER_NAME.equals("alice") && USER_PASSWORD.equals("alice123")) {
            System.out.println(CONST_MSG_SUCCESS); 
        }

        // ③ 「USER_NAME」の値のみ等しい場合。
       //     定数を使用して「 パスワードに誤りがあります。 」 と出力してください。
        else if (USER_NAME.equals("alice") && !(USER_PASSWORD.equals("alice123"))) {
            System.out.println(CONST_MSG_ERROR_PASS);
        }

        // ④ 「USER_PASSWORD」の値のみ等しい場合。
       //定数を使用して「 名前に誤りがあります。 」と出力してください。
        else if (USER_PASSWORD.equals("alice123") && !(USER_NAME.equals("alice"))) {
